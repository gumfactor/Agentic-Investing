...
from signals.indicators.moving_averages.crossovers.ma_cross_5_20 import compute_ma_cross_5_20_scores
from signals.indicators.moving_averages.crossovers.ma_cross_20_50 import compute_ma_cross_20_50_scores
from signals.indicators.moving_averages.crossovers.ma_cross_50_200 import compute_ma_cross_50_200_scores
from signals.indicators.moving_averages.crossovers.ema_cross_12_26 import compute_ema_cross_12_26_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_sma_20 import compute_price_vs_sma_20_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_sma_50 import compute_price_vs_sma_50_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_sma_100 import compute_price_vs_sma_100_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_sma_200 import compute_price_vs_sma_200_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_ema_12 import compute_price_vs_ema_12_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_ema_26 import compute_price_vs_ema_26_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_ema_50 import compute_price_vs_ema_50_scores
from signals.indicators.moving_averages.price_vs_ma.price_vs_ema_200 import compute_price_vs_ema_200_scores
