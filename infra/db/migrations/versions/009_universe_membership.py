...
def upgrade() -> None:
    ...
    # Half-open [effective_start, effective_end) matches daterange's default
    # '[)' bounds; an open-ended row (effective_end IS NULL) is represented
    # with an unbounded upper end.
    op.execute(
        """
