...
| 01B-3 | `dev/R2-01B3-timing-contract` | [#35](https://github.com/gumfactor/Agentic-Investing/pull/35) | PR open — PM-owned Codex babysit cycle | Sonnet 5 medium: 505K (builder incl. fix round) + 158K (adversarial reviewer) | Fable 5/Opus/Sonnet: ~95K |
