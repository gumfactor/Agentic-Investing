...
| BUG-039 | Backtesting | P1 | F1 | Implemented-pending-review (03A-2, branch `dev/R2-03A2-failclosed-objectstore`) | Object-store failures can become unadjusted backtests. |
